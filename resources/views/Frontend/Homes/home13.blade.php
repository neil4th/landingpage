...
@section('content')
    ...
    <div class="swiper-banner-main-wrapper-13 with-lastbanner">
        <div class="swiper mySwiper-13">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <!-- rts banner area start -->
                    <div class="rts-banner-area bg_image banner-bg-14">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7">
                ...
                <div class="swiper-slide">
                    <!-- rts banner area start -->
                    <div class="rts-banner-area bg_image banner-bg-11">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7">
                                    <!-- rts banner content area start -->
                ...
                <div class="swiper-slide">
                    <!-- rts banner area start -->
                    <div class="rts-banner-area bg_image banner-bg-13">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-8">
                                    <!-- rts banner content area start -->
    ...
    <div class="rts-serice-area rts-section-gap">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <div class="rts-about-area-start-9 rts-section-gap">

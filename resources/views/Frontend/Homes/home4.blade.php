...
@section('title')
    Home Foure (Business Consultant)
@endsection
...
@section('content')
                    ...
                    <div class=" col-xl-9 col-lg-8 col-md-8 col-sm-8 col-6">
                        <div class="main-header main-header-four">
                            ...
                            <div class="button-area">
                                ...
                                <a href="#"
                                    class="rts-btn btn-primary btn-primary-4 ml--20 ml_sm--5 header-one-btn quote-btn">Book
                                    a
                                    Meeting</a>
                                <button id="menu-btn"
    ...
    <div class="rts-service-area rts-service-area4 rts-section-gap">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="service-one-inner-four">
                        <div class="big-thumbnail-area">
                            ...
                            <div class="content">
                                ...
                                <p class="disc">Commodo gravida quamta sodales pulvinar habitant tristique auctore sapien
                                    pretiumto turpis dignissim mus feugiat
                                </p>
                            </div>
                    ...
                    <div class="business-goal-right">
                        ...
                        <div class="rts-business-goal pl--30">
                            <div class="single-goal">
                                <img src="{{ asset('assets/images/business-goal/icon/03.svg') }}" alt="business_Icone"
                                    class="thumb">
                            ...
                            <div class="single-goal">
                                <img src="{{ asset('assets/images/business-goal/icon/04.svg') }}" alt="business_Icone"
                                    class="thumb">
                                <div class="goal-wrapper">
    ...
    <!-- start team section -->
    <div class="rts-team-area rts-team-area4 rts-section-gap bg-team">
        <div class="container">
            <div class="row">
                <div class="col-12">
    ...
    <!-- contact area start -->
    <div class="rts-contact-area contact-one contact-four">
        <div class="container">
    ...
    <!-- rts-service area start -->
    <div class="rts-blog-area4 rts-section-gap pb--140">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="text-center title-service-three">

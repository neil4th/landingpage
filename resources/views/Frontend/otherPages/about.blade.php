                ...
                <div class="col-lg-6">
                    <div class="about-image-v-inner">
                        <div class="image-area">
                            <img class="mt--110 img-1" src="{{ asset('assets/images/about/main/about-03.jpg') }}"
                                alt="BUsiness_image">
                            <img class="img-over" src="{{ asset('assets/images/about/main/about-04.jpg') }}"
                                alt="BUsiness_image">
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12 col-12 pt--15 mb--80 mb_md--40 mb_sm--30">
                        <div class="service-one-inner-four">
                            <div class="big-thumbnail-area">
                                ...
                                <div class="content">
                                    <img src="{{ asset('assets/images/service/icon/13.svg') }}" alt="Business-icon">
                            ...
                            <a href="{{ route('serviceDetailsPage') }}" class="rts-btn btn-primary"> Read More<i
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12 col-12 pt--15 mb--80 mb_md--40 mb_sm--30">
                        <div class="service-one-inner-four">
                            <div class="big-thumbnail-area">
                                ...
                                <div class="content">
                                    <img src="{{ asset('assets/images/service/icon/14.svg') }}" alt="Business-icon">
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12 col-12 pt--15 mb--80">
                        <div class="service-one-inner-four">
                            <div class="big-thumbnail-area">
                                ...
                                <div class="content">
                                    <img src="{{ asset('assets/images/service/icon/15.svg') }}" alt="Business-icon">

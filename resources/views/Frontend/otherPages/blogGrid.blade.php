            ...
            <div class="row g-5">
                    ...
                    <div class="row g-5">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            ...
                            <div class="blog-grid-inner">
                                <div class="blog-header">
                                    <a class="thumbnail" href="{{ route('blogDetailsPage') }}">
                                        <img src="{{ asset('assets/images/blog/grid/01.jpg') }}" alt="Business_Blog">
                                    </a>
                                    <div class="blog-info">
                                        <div class="user">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            ...
                            <div class="blog-grid-inner">
                                <div class="blog-header">
                                    <a class="thumbnail" href="{{ route('blogDetailsPage') }}">
                                        <img src="{{ asset('assets/images/blog/grid/02.jpg') }}" alt="Business_Blog">
                                    </a>
                                    <div class="blog-info">
                                        <div class="user">
                                            <i class="fal fa-user-circle"></i>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            ...
                            <div class="blog-grid-inner">
                                <div class="blog-header">
                                    <a class="thumbnail" href="{{ route('blogDetailsPage') }}">
                                        <img src="{{ asset('assets/images/blog/grid/03.jpg') }}" alt="Business_Blog">
                                    </a>
                                    <div class="blog-info">
                                        <div class="user">
                                            <i class="fal fa-user-circle"></i>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            ...
                            <div class="blog-grid-inner">
                                <div class="blog-header">
                                    <a class="thumbnail" href="{{ route('blogDetailsPage') }}">
                                        <img src="{{ asset('assets/images/blog/grid/04.jpg') }}" alt="Business_Blog">
                                    </a>
                                    <div class="blog-info">
                                        <div class="user">
                                            <i class="fal fa-user-circle"></i>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            ...
                            <div class="blog-grid-inner">
                                <div class="blog-header">
                                    <a class="thumbnail" href="{{ route('blogDetailsPage') }}">
                                        <img src="{{ asset('assets/images/blog/grid/05.jpg') }}" alt="Business_Blog">
                                    </a>
                                    <div class="blog-info">
                                        <div class="user">
                                            <i class="fal fa-user-circle"></i>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            ...
                            <div class="blog-grid-inner">
                                <div class="blog-header">
                                    <a class="thumbnail" href="{{ route('blogDetailsPage') }}">
                                        <img src="{{ asset('assets/images/blog/grid/06.jpg') }}" alt="Business_Blog">
                                    </a>
                                    <div class="blog-info">
                                        <div class="user">
                                            <i class="fal fa-user-circle"></i>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            ...
                            <div class="blog-grid-inner">
                                <div class="blog-header">
                                    <a class="thumbnail" href="{{ route('blogDetailsPage') }}">
                                        <img src="{{ asset('assets/images/blog/grid/07.jpg') }}" alt="Business_Blog">
                                    </a>
                                    <div class="blog-info">
                                        <div class="user">
                                            <i class="fal fa-user-circle"></i>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            ...
                            <div class="blog-grid-inner">
                                <div class="blog-header">
                                    <a class="thumbnail" href="{{ route('blogDetailsPage') }}">
                                        <img src="{{ asset('assets/images/blog/grid/08.jpg') }}" alt="Business_Blog">
                                    </a>
                                    <div class="blog-info">
                                        <div class="user">
                                            <i class="fal fa-user-circle"></i>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            ...
                            <div class="blog-grid-inner">
                                <div class="blog-header">
                                    <a class="thumbnail" href="{{ route('blogDetailsPage') }}">
                                        <img src="{{ asset('assets/images/blog/grid/09.jpg') }}" alt="Business_Blog">
                                    </a>
                                    <div class="blog-info">
                                        <div class="user">
                                            <i class="fal fa-user-circle"></i>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            ...
                            <div class="blog-grid-inner">
                                <div class="blog-header">
                                    <a class="thumbnail" href="{{ route('blogDetailsPage') }}">
                                        <img src="{{ asset('assets/images/blog/grid/10.jpg') }}" alt="Business_Blog">
                                    </a>
                                    <div class="blog-info">
                                        <div class="user">
                                            <i class="fal fa-user-circle"></i>
                ...
                <div class="col-xl-4 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="rts-single-wized contact">
                        <div class="wized-header">
                            <a href="{{ route('home') }}"><img src="{{ asset('assets/images/logo/logo-2.svg') }}" alt="Business_logo"></a>
                        </div>
                        <div class="wized-body">

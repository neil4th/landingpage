            ...
            <div class="row g-5">
                ...
                <div class="col-xl-8 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="blog-single-post-listing">
                        ...
                        <div class="blog-listing-content">
                            ...
                            <a class="blog-title" href="{{ route('blogDetailsPage') }}">
                            ...
                            <a class="rts-btn btn-primary" href="{{ route('blogDetailsPage') }}">Read Details</a>
                        </div>
                    </div>
                    <!-- single post End-->
                    <!-- single post -->
                    ...
                    <div class="blog-single-post-listing">
                        <div class="thumbnail">
                            <img src="{{ asset('assets/images/blog/blog-lg-3.jpg') }}" alt="Business-Blog">
                        </div>
                        <div class="blog-listing-content">
                            <div class="user-info">
                                <!-- single info -->
                    ...
                    <div class="blog-single-post-listing mb_sm--15">
                        <div class="thumbnail">
                            <img src="{{ asset('assets/images/blog/blog-lg-4.jpg') }}" alt="Business-Blog">
                        </div>
                        <div class="blog-listing-content">
                            <div class="user-info">
                                <!-- single info -->
                ...
                <div class="col-xl-4 col-md-12 col-sm-12 col-12 mt_lg--60">
                    ...
                    <div class="rts-single-wized Recent-post">
                        ...
                        <div class="wized-body">
                            ...
                            <div class="recent-post-single">
                                <div class="thumbnail">
                                    <a href="#"><img
                                            src="{{ asset('assets/images/blog/details/recent-post/01.png') }}"
                                            alt="Blog_post"></a>
                                </div>
                            ...
                            <div class="recent-post-single">
                                <div class="thumbnail">
                                    <a href="#"><img
                                            src="{{ asset('assets/images/blog/details/recent-post/02.png') }}"
                                            alt="Blog_post"></a>
                                </div>
                                <div class="content-area">
                                    <div class="user">
                            ...
                            <div class="recent-post-single">
                                <div class="thumbnail">
                                    <a href="#"><img
                                            src="{{ asset('assets/images/blog/details/recent-post/03.png') }}"
                                            alt="Blog_post"></a>
                                </div>
                                <div class="content-area">
                                    <div class="user">
                            ...
                            <div class="recent-post-single">
                                <div class="thumbnail">
                                    <a href="#"><img
                                            src="{{ asset('assets/images/blog/details/recent-post/04.png') }}"
                                            alt="Blog_post"></a>
                                </div>
                                <div class="content-area">
                                    <div class="user">
                        ...
                        <div class="wized-body">
                            <div class="gallery-inner">
                                <div class="row-1 single-row">
                                    <a href="#"><img src="{{ asset('assets/images/blog/details/gallery/01.png') }}"
                                            alt="Gallery"></a>
                                    <a href="#"><img src="{{ asset('assets/images/blog/details/gallery/02.png') }}"
                                            alt="Gallery"></a>
                                    <a href="#"><img src="{{ asset('assets/images/blog/details/gallery/03.png') }}"
                                            alt="Gallery"></a>
                                </div>
                                <div class="row-2 single-row">
                                    <a href="#"><img src="{{ asset('assets/images/blog/details/gallery/04.png') }}"
                                            alt="Gallery"></a>
                                    <a href="#"><img src="{{ asset('assets/images/blog/details/gallery/05.png') }}"
                                            alt="Gallery"></a>
                                    <a href="#"><img src="{{ asset('assets/images/blog/details/gallery/06.png') }}"
                                            alt="Gallery"></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="rts-single-wized contact">
                        <div class="wized-header">
                            <a href="#"><img src="{{ asset('assets/images/logo/logo-2.svg') }}"
                                    alt="Business_logo"></a>
                        </div>
                        <div class="wized-body">
                            <h5 class="title">Need Help? We Are Here
                                To Help You</h5>
                            <a class="rts-btn btn-primary" href="{{ route('contactPage') }}">Contact Us</a>
                        </div>
                    </div>
                    <!-- single wized End -->
                </div>

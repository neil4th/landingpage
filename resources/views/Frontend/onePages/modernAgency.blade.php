...
@section('content')
    ...
    <body class="home-nine onepage">

        <!-- start header area -->
        <header class="header--sticky header-home-nine">
            <div class="header-main-one header-main-five six">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-6">
                            <div class="thumbnail">
                                <a href="{{ route('home') }}">
                                    <img src="{{ asset('assets/images/logo/logo-6.svg') }}" alt="finbiz-logo">
                                </a>
                            </div>
                        </div>
                        <div class=" col-xl-9 col-lg-8 col-md-8 col-sm-8 col-6">
                            <div class="main-header main-header-four main-header-five main-header-six seven">
                                ...
                                <div class="button-area">
                                    ...
                                    <a href="#"
                                        class="rts-btn btn-nine six ml--20 ml_sm--5 header-one-btn quote-btn">Book a
                                        Meeting</a>
                                    <button id="menu-btn"
                        ...
                        <ul class="mainmenu">
                            <li class="has-droupdown menu-item">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            <li><a href="{{ route('main') }}">Main Home OnePage</a></li>
                                            <li><a href="{{ route('consulting') }}">Consulting Home OnePage</a></li>
                                            <li><a href="{{ route('corporate') }}">Corporate Home OnePage</a></li>
                                            <li><a href="{{ route('insurance') }}">Insurance Home OnePage</a></li>
                                            <li><a href="{{ route('marketing') }}">Marketing Home OnePage</a></li>
                                            <li><a href="{{ route('finance') }}">Finance Home OnePage</a></li>
                                            <li><a href="{{ route('humanResource') }}">Human resource OnePage</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="has-droupdown menu-item">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li class="mobile-menu-link"><a href="{{ route('portfolioDetails') }}">Project
                                            Details</a></li>
                                    <li class="mobile-menu-link"><a href={{ route('teamDetails') }}">Team</a></li>
                            ...
                            <li class="has-droupdown menu-item">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li class="mobile-menu-link"><a href="{{ route('blogDetailsPage') }}">Blog
                                            Details</a></li>
                                </ul>
                            </li>
        ...
        <!-- banner nine image area start -->
        <div class="banner-area-nine bg_image" id="banner">
            <div class="inner">
                <div class="banner-image-right-top">
                    <img src="{{ asset('assets/images/banner/banner-12.png') }}" alt="banner_image">
                </div>
                <div class="banner-image-left-bottom">
                    <img src="{{ asset('assets/images/banner/banner-13.png') }}" alt="banner_image">
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="banner-inner-content">
                                <div class="main-wrapper">
                                    <h1 class="title">Collaborative <br>
                                        Whiteboarding Platform</h1>
                                    <p class="disc">
                                        Maecenas quis integer aenean nisl, viverra morbi magna amet, viverra. Sollicitudin
                                        posuere scelerisque urna, urna. At vestibulum fringilla.
                                    </p>
                                    <a href="#" class="rts-btn btn-nine">View Services</a>
        ...
        <div class="why-choose-us-nine rts-section-gapTop" id="services">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                ...
                <div class="row g-24 g-sm-5 mt--50 mt_sm--0">
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="service-style-nine">
                            <div class="icon">
                            ...
                            <div class="inner-content">
                                ...
                                <p class="dsic">
                                    A competent SEO consultant begins by <br> conducting a thorough audi...
                                </p>
                                <a href="#" class="read-more-btn">View More <i class="far fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="service-style-nine active">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="51" height="56"
                                    viewBox="0 0 51 56" fill="none">
                                    <path
                                        d="M36.6257 12.33C34.8272 10.7213 32.703 9.51231 30.3953 8.78406C28.0877 8.0558 25.6498 7.82507 23.245 8.1073C19.6152 8.51857 16.2131 10.0706 13.5358 12.5366C10.8585 15.0027 9.04622 18.2535 8.36382 21.8141C7.68142 25.3746 8.16464 29.0584 9.74287 32.3272C11.3211 35.5959 13.9116 38.2783 17.136 39.9824V50C17.1365 50.5303 17.3491 51.0387 17.7271 51.4136C18.105 51.7886 18.6175 51.9995 19.152 52H21.168V54C21.1685 54.5303 21.3811 55.0387 21.7591 55.4136C22.137 55.7886 22.6495 55.9995 23.184 56H27.216C27.7505 55.9995 28.263 55.7886 28.6409 55.4136C29.0189 55.0387 29.2315 54.5303 29.232 54V52H31.248C31.7825 51.9995 32.295 51.7886 32.6729 51.4136C33.0509 51.0387 33.2635 50.5303 33.264 50V39.9829C35.6969 38.6974 37.7809 36.8482 39.3389 34.5924C40.8969 32.3366 41.8829 29.7409 42.2129 27.026C42.5429 24.3112 42.2073 21.5574 41.2346 18.9988C40.2618 16.4402 38.6807 14.1524 36.6257 12.33ZM31.248 44V46H19.152V44H31.248ZM27.2175 54H23.184V52H27.2165L27.2175 54ZM19.152 50V48H31.248V50H19.152ZM31.814 38.4722C31.6442 38.5542 31.5011 38.682 31.4011 38.8408C31.301 38.9997 31.2479 39.1833 31.248 39.3706V42H26.208V37.4141L28.9367 34.707C29.1203 34.5184 29.2219 34.2658 29.2196 34.0036C29.2173 33.7414 29.1113 33.4906 28.9244 33.3052C28.7375 33.1198 28.4847 33.0146 28.2204 33.0123C27.9561 33.01 27.7015 33.1108 27.5113 33.293L25.2 35.5859L22.8887 33.293C22.6985 33.1108 22.4439 33.01 22.1796 33.0123C21.9153 33.0146 21.6625 33.1198 21.4756 33.3052C21.2887 33.4906 21.1827 33.7414 21.1804 34.0036C21.1781 34.2658 21.2797 34.5184 21.4633 34.707L24.192 37.4141V42H19.152V39.3706C19.1521 39.1833 19.099 38.9997 18.9989 38.8408C18.8989 38.682 18.7558 38.5542 18.586 38.4722C15.6435 37.0545 13.2442 34.7277 11.7487 31.8415C10.2532 28.9553 9.74218 25.6655 10.2925 22.4666C10.8428 19.2676 12.4247 16.3322 14.8005 14.1014C17.1763 11.8707 20.2176 10.465 23.4675 10.0957C24.0497 10.0312 24.6349 9.99874 25.2207 9.9985C28.9363 9.9875 32.5229 11.3499 35.281 13.82C37.1298 15.4593 38.5434 17.525 39.397 19.8347C40.2505 22.1443 40.5177 24.6269 40.1751 27.0633C39.8324 29.4997 38.8904 31.8149 37.4322 33.8046C35.9741 35.7943 34.0445 37.3975 31.814 38.4722Z"
                                        fill="#E87556" />
                                    <path
                                        d="M25.2 6C25.4673 6 25.7237 5.89464 25.9128 5.70711C26.1018 5.51957 26.208 5.26522 26.208 5V1C26.208 0.734784 26.1018 0.48043 25.9128 0.292893C25.7237 0.105357 25.4673 0 25.2 0C24.9327 0 24.6763 0.105357 24.4872 0.292893C24.2982 0.48043 24.192 0.734784 24.192 1V5C24.192 5.26522 24.2982 5.51957 24.4872 5.70711C24.6763 5.89464 24.9327 6 25.2 6Z"
                                        fill="#E87556" />
                                    <path
                                        d="M10.2321 11.5649C10.3251 11.6604 10.4363 11.7366 10.5593 11.789C10.6823 11.8414 10.8145 11.869 10.9484 11.8701C11.0822 11.8713 11.215 11.846 11.3388 11.7957C11.4627 11.7454 11.5753 11.6712 11.6699 11.5773C11.7646 11.4834 11.8394 11.3717 11.8901 11.2489C11.9408 11.126 11.9663 10.9943 11.9651 10.8615C11.9639 10.7287 11.9361 10.5975 11.8833 10.4755C11.8305 10.3535 11.7537 10.2431 11.6574 10.1509L8.80619 7.3223C8.71321 7.22679 8.60198 7.15061 8.479 7.0982C8.35602 7.04579 8.22375 7.0182 8.08991 7.01705C7.95606 7.0159 7.82333 7.0412 7.69945 7.09148C7.57557 7.14176 7.46303 7.21601 7.36838 7.3099C7.27374 7.4038 7.19889 7.51545 7.14821 7.63835C7.09753 7.76124 7.07202 7.89292 7.07318 8.0257C7.07435 8.15848 7.10216 8.2897 7.15498 8.4117C7.20781 8.53371 7.2846 8.64405 7.38088 8.7363L10.2321 11.5649Z"
                                        fill="#E87556" />
                                    <path
                                        d="M5.04 24H1.008C0.740662 24 0.484273 24.1054 0.295237 24.2929C0.1062 24.4804 0 24.7348 0 25C0 25.2652 0.1062 25.5196 0.295237 25.7071C0.484273 25.8946 0.740662 26 1.008 26H5.04C5.30734 26 5.56373 25.8946 5.75276 25.7071C5.9418 25.5196 6.048 25.2652 6.048 25C6.048 24.7348 5.9418 24.4804 5.75276 24.2929C5.56373 24.1054 5.30734 24 5.04 24Z"
                                        fill="#E87556" />
                                    <path
                                        d="M10.2321 38.4351L7.38088 41.2637C7.2846 41.3559 7.20781 41.4663 7.15498 41.5883C7.10216 41.7103 7.07435 41.8415 7.07318 41.9743C7.07202 42.1071 7.09753 42.2388 7.14821 42.3617C7.19889 42.4846 7.27374 42.5962 7.36838 42.6901C7.46303 42.784 7.57557 42.8582 7.69945 42.9085C7.82333 42.9588 7.95606 42.9841 8.08991 42.983C8.22375 42.9818 8.35602 42.9542 8.479 42.9018C8.60198 42.8494 8.71321 42.7732 8.80619 42.6777L11.6574 39.8491C11.841 39.6605 11.9426 39.4079 11.9403 39.1457C11.938 38.8835 11.832 38.6327 11.6451 38.4473C11.4582 38.2619 11.2054 38.1567 10.9411 38.1544C10.6768 38.1521 10.4222 38.2529 10.2321 38.4351Z"
                                        fill="#E87556" />
                                    <path
                                        d="M41.5938 7.3223L38.7426 10.1509C38.6463 10.2431 38.5695 10.3535 38.5167 10.4755C38.4639 10.5975 38.436 10.7287 38.4349 10.8615C38.4337 10.9943 38.4592 11.126 38.5099 11.2489C38.5606 11.3717 38.6354 11.4834 38.7301 11.5773C38.8247 11.6712 38.9373 11.7454 39.0611 11.7957C39.185 11.846 39.3178 11.8713 39.4516 11.8701C39.5854 11.869 39.7177 11.8414 39.8407 11.789C39.9637 11.7366 40.0749 11.6604 40.1679 11.5649L43.0191 8.7363C43.1154 8.64405 43.1922 8.53371 43.245 8.4117C43.2978 8.2897 43.3256 8.15848 43.3268 8.0257C43.328 7.89292 43.3025 7.76124 43.2518 7.63835C43.2011 7.51545 43.1263 7.4038 43.0316 7.3099C42.937 7.21601 42.8244 7.14176 42.7005 7.09148C42.5767 7.0412 42.4439 7.0159 42.3101 7.01705C42.1763 7.0182 42.044 7.04579 41.921 7.0982C41.798 7.15061 41.6868 7.22679 41.5938 7.3223Z"
                                        fill="#E87556" />
                                    <path
                                        d="M40.1679 38.4351C39.9778 38.2529 39.7232 38.1521 39.4589 38.1544C39.1946 38.1567 38.9417 38.2619 38.7549 38.4473C38.568 38.6327 38.462 38.8835 38.4597 39.1457C38.4574 39.4079 38.559 39.6605 38.7426 39.8491L41.5938 42.6777C41.7839 42.8599 42.0385 42.9607 42.3028 42.9584C42.5671 42.9561 42.8199 42.8509 43.0068 42.6655C43.1937 42.4801 43.2997 42.2293 43.302 41.9671C43.3043 41.7049 43.2027 41.4523 43.0191 41.2637L40.1679 38.4351Z"
                                        fill="#E87556" />
                                    <path
                                        d="M49.392 24H45.36C45.0927 24 44.8363 24.1054 44.6472 24.2929C44.4582 24.4804 44.352 24.7348 44.352 25C44.352 25.2652 44.4582 25.5196 44.6472 25.7071C44.8363 25.8946 45.0927 26 45.36 26H49.392C49.6593 26 49.9157 25.8946 50.1048 25.7071C50.2938 25.5196 50.4 25.2652 50.4 25C50.4 24.7348 50.2938 24.4804 50.1048 24.2929C49.9157 24.1054 49.6593 24 49.392 24Z"
                                        fill="#E87556" />
                                </svg>
                            </div>
                            <div class="inner-content">
        ...
        <div class="more-about-us-section rts-section-gap" id="about-us">
            <div class="container">
                <div class="row align-items-center g-5">
                    <div class="col-lg-6">
                        <div class="about-left-style-nine">
                            <div class="thumbnail">
                                <img src="{{ asset('assets/images/about/03.png') }}" alt="about_business">
                            </div>
                            <div class="business-revinew">
                    ...
                    <div class="col-lg-6">
                        <div class="about-right-content-nine">
                            <div class="text-left title-area-nine">
                                <p class="pre-title">
                                    More About Us
                                </p>
                                <h2 class="title">Better Solutions For your <br>
                                    Modern Agency</h2>
                            </div>
                            <div class="inner-content-wrapper">
                                <p class="disc">
                                    Platea vehicula rutrum curae magna taciti acut quis malesuada inceptos phasellus massa,
                                    eget ultrices tempor lacinia dictumst tincidunt leo mollis luctus varius gravida
                                ...
                                <div class="single-feature-area-nine">
                                    <div class="icon-area">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="41" height="41"
                                            ...
                                            <path
                                                d="M36.2401 33.4747C37.1381 32.7431 37.7155 31.6236 37.7155 30.3691C37.7155 28.1705 35.9478 26.3825 33.7741 26.3825C31.6004 26.3825 29.8326 28.1705 29.8326 30.3691C29.8326 31.6236 30.4101 32.7431 31.308 33.4747C29.9062 33.9916 28.706 34.9318 27.8619 36.147V35.6846C27.8619 32.5312 25.8735 29.8462 23.102 28.8237C23.7057 28.3326 24.1649 27.6669 24.4 26.9015C24.6674 26.9918 24.9472 27.047 25.2343 27.047C26.6834 27.047 27.8619 25.855 27.8619 24.3892V22.8318L29.8944 24.8876C30.3089 25.3075 30.8016 25.5799 31.3179 25.6736C31.4828 25.7035 31.647 25.7188 31.8099 25.7188C32.5043 25.7188 33.1605 25.447 33.6617 24.9401C34.157 24.4377 34.431 23.7707 34.431 23.0604C34.431 22.3501 34.157 21.683 33.6998 21.2239L28.7343 15.2341C28.011 14.3617 27.1636 13.6062 26.2157 12.9896L19.6592 8.72596C18.7264 8.11934 17.651 7.7333 16.55 7.61038L13.527 7.27086L14.3389 6.44962L8.81171 0.859108L0 9.77178L5.52719 15.3623L6.0041 14.8799L6.72735 16.3423C7.31659 17.5343 8.0878 18.616 9.01929 19.5582C9.46927 20.0133 9.95866 20.4365 10.4737 20.8159L16.3674 25.1513C16.4784 25.2331 16.5954 25.3028 16.7143 25.3673C16.7044 25.4836 16.6946 25.6005 16.6946 25.7181C16.6946 26.9725 17.272 28.0921 18.17 28.8237C15.3985 29.8462 13.41 32.5312 13.41 35.6846V36.1463C12.5659 34.9311 11.3658 33.9916 9.96392 33.474C10.8619 32.7431 11.4393 31.6236 11.4393 30.3691C11.4393 28.1705 9.6716 26.3825 7.4979 26.3825C5.32421 26.3825 3.55648 28.1705 3.55648 30.3691C3.55648 31.6236 4.1339 32.7431 5.03188 33.4747C2.26041 34.4972 0.271958 37.1822 0.271958 40.3356V41H14.7238V40.3356C14.7238 38.8645 14.2883 37.4965 13.5467 36.349H27.7259C26.9836 37.4965 26.5481 38.8645 26.5481 40.3356V41H41V40.3356C41 37.1822 39.0116 34.4972 36.2401 33.4747ZM4.87029 30.3691C4.87029 28.9034 6.04877 27.7114 7.4979 27.7114C8.94703 27.7114 10.1255 28.9034 10.1255 30.3691C10.1255 31.8348 8.94703 33.0268 7.4979 33.0268C6.04877 33.0268 4.87029 31.8348 4.87029 30.3691ZM9.32738 34.6547L7.4979 36.6898L5.66842 34.6547C6.24584 34.464 6.85873 34.3557 7.4979 34.3557C8.13707 34.3557 8.74996 34.464 9.32738 34.6547ZM1.6219 39.6711C1.82816 37.7948 2.89629 36.1789 4.41505 35.2361L7.4979 38.6659L10.5801 35.2361C12.0989 36.1789 13.1676 37.7948 13.3732 39.6711H1.6219ZM21.1076 21.7628C20.946 21.305 20.6872 20.8844 20.3233 20.5528L15.5141 16.1749L20.5887 17.5748C20.8731 17.6532 21.1418 17.7768 21.3875 17.9423C22.1508 18.4579 22.6067 19.3196 22.6067 20.2478V22.271C22.1554 22.0059 21.6489 21.8285 21.1076 21.7628ZM32.7322 22.1209C32.9805 22.372 33.1172 22.7056 33.1172 23.0604C33.1172 23.4152 32.9805 23.7487 32.7322 23.9999C32.4228 24.3135 31.9938 24.4451 31.5511 24.366C31.2338 24.3082 30.9802 24.1069 30.8239 23.9481L27.8619 20.9528V16.2493L32.7322 22.1209ZM1.85772 9.77178L8.81171 2.73812L12.4812 6.44962L5.52719 13.4833L1.85772 9.77178ZM11.2469 19.7416C10.787 19.4027 10.3495 19.0253 9.94815 18.6193C9.11651 17.7782 8.42873 16.8127 7.90255 15.7483L6.98354 13.8899L12.338 8.47414L16.4055 8.93194C17.3068 9.03293 18.1864 9.34853 18.9497 9.84486L25.5063 14.1085C25.8722 14.3464 26.2183 14.6121 26.5488 14.8959V24.3892C26.5488 25.1221 25.9595 25.7181 25.235 25.7181C24.9978 25.7181 24.7692 25.6523 24.5689 25.5327C24.5347 24.7912 24.3035 24.1015 23.9212 23.5188V20.2472C23.9212 18.8738 23.2465 17.5988 22.1166 16.8367C21.7527 16.5915 21.3553 16.4081 20.9349 16.2925L14.241 14.446C14.0433 14.3922 13.8324 14.4334 13.6695 14.559C13.5059 14.6852 13.41 14.8799 13.41 15.0872V15.7516C13.41 15.9403 13.4889 16.1197 13.6275 16.2453L19.4444 21.5402C19.784 21.8498 19.9791 22.2923 19.9791 22.7554C19.9791 23.6557 19.2539 24.3892 18.3637 24.3892H18.0905C17.7469 24.3892 17.4185 24.2809 17.1406 24.077L11.2469 19.7416ZM18.0084 25.7181C18.0084 25.7161 18.009 25.7141 18.009 25.7115C18.0366 25.7121 18.0629 25.7181 18.0905 25.7181H18.3637C19.8477 25.7181 21.0643 24.5919 21.2548 23.1428C22.4044 23.4258 23.2636 24.469 23.2636 25.7181C23.2636 27.1838 22.0851 28.3758 20.636 28.3758C19.1868 28.3758 18.0084 27.1838 18.0084 25.7181ZM22.4655 30.0037L20.636 32.0388L18.8065 30.0037C19.3839 29.813 19.9968 29.7047 20.636 29.7047C21.2751 29.7047 21.888 29.813 22.4655 30.0037ZM14.76 35.0201C14.9662 33.1438 16.0344 31.5279 17.5531 30.5851L20.636 34.0148L23.7182 30.5851C25.2369 31.5279 26.3057 33.1438 26.5113 35.0201H14.76ZM31.1464 30.3691C31.1464 28.9034 32.3249 27.7114 33.7741 27.7114C35.2232 27.7114 36.4017 28.9034 36.4017 30.3691C36.4017 31.8348 35.2232 33.0268 33.7741 33.0268C32.3249 33.0268 31.1464 31.8348 31.1464 30.3691ZM35.6035 34.6547L33.7741 36.6898L31.9446 34.6547C32.522 34.464 33.1349 34.3557 33.7741 34.3557C34.4132 34.3557 35.0261 34.464 35.6035 34.6547ZM27.8981 39.6711C28.1043 37.7948 29.1724 36.1789 30.6912 35.2361L33.7741 38.6659L36.8563 35.2361C38.375 36.1789 39.4438 37.7948 39.6494 39.6711H27.8981Z"
                                                fill="#E87556" />
                                            <path
                                                d="M40.8075 0.939504L39.8787 0L35.0879 4.84569L34.2385 3.98658L33.3096 4.92609L35.0879 6.7247L40.8075 0.939504Z"
                                                fill="#E87556" />
                                            <path
                                                d="M35.0879 12.4295C36.1744 12.4295 37.0586 11.5352 37.0586 10.4362C37.0586 9.33724 36.1744 8.44291 35.0879 8.44291C34.0013 8.44291 33.1172 9.33724 33.1172 10.4362C33.1172 11.5352 34.0013 12.4295 35.0879 12.4295ZM35.0879 9.77178C35.4498 9.77178 35.7448 10.0701 35.7448 10.4362C35.7448 10.8023 35.4498 11.1006 35.0879 11.1006C34.7259 11.1006 34.431 10.8023 34.431 10.4362C34.431 10.0701 34.7259 9.77178 35.0879 9.77178Z"
                                                fill="#E87556" />
                                            <path d="M23.9205 4.45633H31.8033V5.78519H23.9205V4.45633Z" fill="#E87556" />
                                            <path d="M23.9205 9.77178H29.1757V11.1006H23.9205V9.77178Z" fill="#E87556" />
                                            <path d="M30.4895 9.77178H31.8033V11.1006H30.4895V9.77178Z" fill="#E87556" />
                                            <path d="M23.9205 7.11405H31.8033V8.44291H23.9205V7.11405Z" fill="#E87556" />
                                        </svg>
                                    </div>
                                    <div class="info-area">
                                        <h6 class="title">Expert Team Management </h6>
                                ...
                                <div class="single-feature-area-nine">
                                    <div class="icon-area">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="41" height="40"
                                            ...
                                            <path
                                                d="M0.625296 40H25.262C25.4278 40 25.5868 39.9341 25.704 39.8169C25.8212 39.6997 25.8871 39.5407 25.8871 39.3749V33.3973C25.8967 32.4893 25.6157 31.602 25.0851 30.8651C24.5545 30.1282 23.8022 29.5802 22.9381 29.3013L16.625 27.1969V25.2034C16.625 25.1818 16.6239 25.1604 16.6218 25.1394C17.4208 24.5097 18.0469 23.6874 18.4413 22.7496C18.898 22.7484 19.3448 22.6173 19.7297 22.3716C20.1146 22.1259 20.4217 21.7757 20.615 21.3621C20.8084 20.9484 20.8801 20.4882 20.8217 20.0353C20.7633 19.5825 20.5772 19.1555 20.2852 18.8044C20.3784 18.3738 20.5345 17.5789 20.6019 17.1216C20.6225 16.9815 20.6429 16.85 20.6622 16.7256C20.8435 15.5571 20.9528 14.8519 20.2501 13.5287C19.4866 12.0923 18.3195 10.9106 16.8926 10.1293C15.4658 9.348 13.8415 9.00123 12.22 9.1317C10.5985 9.26217 9.0506 9.8642 7.76704 10.8636C6.48348 11.863 5.52034 13.2161 4.99633 14.7561C4.98521 14.7888 4.97682 14.8223 4.97125 14.8564C4.76287 16.1281 4.93999 17.4556 5.49653 18.8056C5.20513 19.1565 5.01946 19.583 4.96114 20.0353C4.90282 20.4877 4.97425 20.9473 5.16712 21.3606C5.35999 21.774 5.66634 22.124 6.05049 22.3699C6.43464 22.6157 6.88075 22.7474 7.33686 22.7495C7.74255 23.7093 8.38911 24.5481 9.21398 25.1848C9.22961 25.197 9.2461 25.2082 9.26203 25.2202V27.1969L2.94895 29.3013C2.08486 29.5803 1.33262 30.1282 0.802111 30.8652C0.271604 31.6021 -0.00936824 32.4893 0.000238384 33.3973V39.3749C0.000238384 39.5407 0.0660925 39.6997 0.183314 39.8169C0.300535 39.9341 0.459521 40 0.625296 40ZM14.4795 31.6765L14.2281 33.1133H11.6591L11.4343 31.8282C11.4229 31.7631 11.4012 31.7002 11.37 31.642L12.9437 30.5247L14.4916 31.6239C14.4871 31.6409 14.4828 31.6584 14.4795 31.6765ZM11.8295 34.3634H14.0587L14.8254 38.7499H11.0618L11.8295 34.3634ZM24.6374 33.3973V38.7499H21.6479V36.0148C21.6479 35.849 21.5821 35.69 21.4649 35.5728C21.3477 35.4556 21.1887 35.3897 21.0229 35.3897C20.8571 35.3897 20.6981 35.4556 20.5809 35.5728C20.4637 35.69 20.3978 35.849 20.3978 36.0148V38.7499H16.0945L15.3029 34.2243L15.6179 32.4234L17.4072 33.694C17.5007 33.7604 17.6107 33.7998 17.7251 33.8079C17.8395 33.816 17.9539 33.7924 18.0558 33.7398C18.1577 33.6872 18.2432 33.6075 18.3029 33.5096C18.3626 33.4116 18.3941 33.2991 18.3941 33.1844V29.1041L22.543 30.4871C23.1568 30.6854 23.6911 31.0748 24.0678 31.5983C24.4446 32.1219 24.644 32.7523 24.637 33.3973H24.6374ZM17.1445 28.6874V31.9739L14.0238 29.7577L16.0464 28.3213L17.1445 28.6874ZM18.829 21.4289C18.9541 20.706 18.946 19.9662 18.8052 19.2462C19.0323 19.3229 19.23 19.4684 19.3708 19.6624C19.5117 19.8564 19.5887 20.0894 19.5913 20.3291C19.594 20.5688 19.522 20.8034 19.3854 21.0005C19.2489 21.1975 19.0544 21.3472 18.829 21.4289ZM6.19683 15.1094C6.65045 13.8079 7.47378 12.6669 8.56598 11.8262C9.65818 10.9854 10.9718 10.4815 12.3461 10.3759C13.7204 10.2704 15.0956 10.568 16.3033 11.2321C17.5111 11.8962 18.4989 12.8982 19.1459 14.1152C19.6538 15.071 19.5965 15.4398 19.4268 16.534C19.407 16.6614 19.3862 16.796 19.365 16.9396C19.3223 17.2294 19.2409 17.6671 19.1651 18.0479C18.9286 17.9722 18.6818 17.9338 18.4335 17.9339H18.4112C17.7045 15.6018 16.9063 14.3945 15.9068 14.1417C15.4685 14.0306 14.7857 14.0604 14.0229 14.8318C13.9868 14.8682 13.9553 14.9089 13.9292 14.953C12.7861 16.8845 10.7447 17.807 7.86292 17.6954C7.7644 17.6916 7.66637 17.7112 7.57688 17.7526C7.4874 17.794 7.409 17.856 7.34811 17.9336C7.07626 17.9336 6.8064 17.9799 6.55006 18.0704C6.17081 17.0477 6.05189 16.0537 6.19683 15.1094ZM6.19136 20.3418C6.19174 20.1085 6.26259 19.8806 6.39462 19.6882C6.52666 19.4957 6.71373 19.3476 6.93135 19.2632C6.80756 19.9784 6.8106 20.7097 6.94033 21.4237C6.72052 21.3406 6.53116 21.1927 6.39739 20.9995C6.26363 20.8062 6.19177 20.5769 6.19136 20.3419V20.3418ZM8.28312 18.955H8.33281C11.4061 18.955 13.6348 17.8482 14.9626 15.6607C15.1502 15.481 15.3974 15.3018 15.6003 15.3536C15.7916 15.4019 16.478 15.7716 17.2744 18.4957C17.281 18.5181 17.2888 18.5401 17.2979 18.5616C17.7048 19.5338 17.7789 20.6133 17.5086 21.632C17.2384 22.6507 16.6389 23.5514 15.8035 24.194C14.9682 24.8366 13.9438 25.185 12.8899 25.185C11.8359 25.185 10.8116 24.8365 9.97624 24.1938C9.20258 23.59 8.62772 22.7681 8.32591 21.8342C8.02409 20.9003 8.00919 19.8974 8.28312 18.955ZM12.8898 26.4334C13.7469 26.4333 14.5942 26.2506 15.3752 25.8974V27.2644L12.9437 28.9912L10.5121 27.2644V25.9464C11.2635 26.2681 12.0724 26.4338 12.8898 26.4334ZM9.84154 28.3213L11.8642 29.7577L8.74324 31.9739V28.6874L9.84154 28.3213ZM1.25035 33.3973C1.24335 32.7523 1.44278 32.122 1.81951 31.5984C2.19624 31.0748 2.73052 30.6855 3.3443 30.4872L7.49312 29.1042V33.1845C7.49313 33.2992 7.5247 33.4117 7.58437 33.5097C7.64404 33.6076 7.72951 33.6873 7.83142 33.7399C7.93334 33.7925 8.04776 33.8161 8.16218 33.808C8.27659 33.7999 8.38657 33.7605 8.48009 33.6941L10.2693 32.4236L10.5843 34.2244L9.79279 38.7499H5.48942V36.0148C5.48942 35.849 5.42357 35.69 5.30634 35.5728C5.18912 35.4556 5.03014 35.3897 4.86436 35.3897C4.69859 35.3897 4.5396 35.4556 4.42238 35.5728C4.30516 35.69 4.2393 35.849 4.2393 36.0148V38.7499H1.25035V33.3973ZM40.0039 13.8366C40.0039 14.0024 39.9381 14.1614 39.8209 14.2786C39.7037 14.3958 39.5447 14.4617 39.3789 14.4617H22.9176C22.7518 14.4617 22.5928 14.3958 22.4756 14.2786C22.3584 14.1614 22.2925 14.0024 22.2925 13.8366C22.2925 13.6709 22.3584 13.5119 22.4756 13.3947C22.5928 13.2774 22.7518 13.2116 22.9176 13.2116H25.2899V9.32059C25.2899 9.15482 25.3558 8.99583 25.473 8.87861C25.5902 8.76139 25.7492 8.69553 25.915 8.69553C26.0808 8.69553 26.2397 8.76139 26.357 8.87861C26.4742 8.99583 26.54 9.15482 26.54 9.32059V13.2116H28.7788V6.14639C28.7788 5.98062 28.8446 5.82163 28.9618 5.70441C29.0791 5.58719 29.238 5.52133 29.4038 5.52133C29.5696 5.52133 29.7286 5.58719 29.8458 5.70441C29.963 5.82163 30.0289 5.98062 30.0289 6.14639V13.2116H32.2676V7.56191C32.2676 7.39614 32.3335 7.23715 32.4507 7.11993C32.5679 7.00271 32.7269 6.93686 32.8927 6.93686C33.0584 6.93686 33.2174 7.00271 33.3346 7.11993C33.4519 7.23715 33.5177 7.39614 33.5177 7.56191V13.2116H35.7565V4.34474C35.7565 4.17896 35.8224 4.01998 35.9396 3.90276C36.0568 3.78554 36.2158 3.71968 36.3816 3.71968C36.5474 3.71968 36.7063 3.78554 36.8236 3.90276C36.9408 4.01998 37.0066 4.17896 37.0066 4.34474V13.2116H39.3789C39.5447 13.2116 39.7037 13.2774 39.8209 13.3947C39.9381 13.5119 40.0039 13.6709 40.0039 13.8366ZM35.9578 0.161851C36.0799 0.0511805 36.2409 -0.00676413 36.4055 0.000629853C36.5702 0.00802383 36.7253 0.0801578 36.837 0.201331C36.9487 0.322504 37.0081 0.482908 37.0021 0.647628C36.9962 0.812348 36.9254 0.968049 36.8052 1.08084L33.3164 4.29802C33.2292 4.37837 33.121 4.43228 33.0044 4.45348C32.8878 4.47467 32.7676 4.46227 32.6577 4.41772L29.5334 3.1501L26.3356 6.05935C26.2129 6.16993 26.0513 6.22739 25.8863 6.21919C25.7213 6.21099 25.5662 6.13778 25.455 6.01557C25.3438 5.89337 25.2855 5.73211 25.2929 5.56704C25.3003 5.40198 25.3727 5.24655 25.4943 5.13473L28.9832 1.96046C29.0703 1.88109 29.1781 1.82798 29.2941 1.80724C29.4101 1.78651 29.5296 1.79899 29.6388 1.84326L32.7604 3.1097L35.9578 0.161851ZM22.7818 19.7091C22.643 19.7399 22.5189 19.8172 22.4299 19.9281C22.3409 20.0391 22.2925 20.177 22.2925 20.3192V21.8968C22.2925 22.039 22.3409 22.1769 22.4299 22.2878C22.5189 22.3987 22.643 22.476 22.7818 22.5069L23.2611 22.6135C23.3403 22.8576 23.4387 23.095 23.5555 23.3235L23.2918 23.7379C23.2154 23.8579 23.1823 24.0004 23.1978 24.1417C23.2133 24.2831 23.2766 24.415 23.3772 24.5155L24.4927 25.6308C24.5932 25.7313 24.725 25.7946 24.8664 25.8101C25.0077 25.8256 25.1501 25.7925 25.2701 25.7162L25.6846 25.4526C25.913 25.5694 26.1505 25.6678 26.3946 25.7469L26.5011 26.2261C26.532 26.3649 26.6093 26.4891 26.7202 26.578C26.8311 26.667 26.9691 26.7155 27.1113 26.7155H28.6886C28.8308 26.7155 28.9687 26.667 29.0797 26.578C29.1906 26.4891 29.2679 26.3649 29.2987 26.2261L29.4053 25.7469C29.6494 25.6678 29.8869 25.5694 30.1154 25.4526L30.5295 25.7162C30.6494 25.7925 30.7919 25.8256 30.9332 25.8101C31.0745 25.7946 31.2063 25.7313 31.3069 25.6308L32.4224 24.5155C32.523 24.415 32.5862 24.2831 32.6018 24.1417C32.6173 24.0004 32.5841 23.8579 32.5078 23.7379L32.2441 23.3235C32.3609 23.095 32.4593 22.8576 32.5385 22.6135L33.0177 22.5069C33.1566 22.476 33.2807 22.3987 33.3696 22.2878C33.4586 22.1769 33.5071 22.039 33.5071 21.8968V20.319C33.5071 20.1768 33.4586 20.0389 33.3696 19.928C33.2807 19.817 33.1566 19.7398 33.0177 19.7089L32.5384 19.6023C32.4593 19.3583 32.3609 19.1209 32.2441 18.8924L32.5078 18.4778C32.5841 18.3579 32.6172 18.2154 32.6017 18.0741C32.5861 17.9327 32.5229 17.8009 32.4223 17.7004L31.307 16.585C31.2064 16.4845 31.0746 16.4212 30.9332 16.4057C30.7919 16.3902 30.6494 16.4234 30.5295 16.4997L30.1154 16.7633C29.8869 16.6465 29.6494 16.5481 29.4053 16.4689L29.2987 15.9896C29.2678 15.8509 29.1906 15.7268 29.0796 15.6378C28.9687 15.5489 28.8308 15.5004 28.6886 15.5004H27.1113C26.9691 15.5004 26.8312 15.5489 26.7202 15.6378C26.6093 15.7268 26.532 15.8509 26.5011 15.9896L26.3946 16.4689C26.1505 16.548 25.913 16.6465 25.6846 16.7633L25.2701 16.4997C25.1501 16.4234 25.0077 16.3902 24.8663 16.4057C24.725 16.4212 24.5931 16.4845 24.4926 16.585L23.3774 17.7004C23.2768 17.8009 23.2136 17.9327 23.198 18.0741C23.1825 18.2154 23.2156 18.3579 23.2919 18.4778L23.5556 18.8924C23.4388 19.1209 23.3404 19.3583 23.2612 19.6024L22.7818 19.7091ZM23.5426 20.8205L23.8975 20.7417C24.0123 20.7161 24.1175 20.6587 24.2011 20.5761C24.2847 20.4935 24.3433 20.3889 24.3702 20.2745C24.4595 19.8953 24.6098 19.5331 24.8151 19.202C24.877 19.102 24.9095 18.9866 24.9088 18.8691C24.9081 18.7515 24.8742 18.6365 24.8111 18.5373L24.6158 18.23L25.0221 17.8237L25.3294 18.0191C25.4285 18.0821 25.5434 18.1158 25.6609 18.1165C25.7783 18.1173 25.8936 18.0848 25.9935 18.023C26.3246 17.8177 26.6869 17.6674 27.0662 17.5782C27.1806 17.5513 27.2851 17.4927 27.3678 17.4091C27.4504 17.3255 27.5078 17.2203 27.5333 17.1056L27.6122 16.7507H28.1869L28.2658 17.1056C28.2914 17.2204 28.3487 17.3256 28.4314 17.4092C28.514 17.4928 28.6185 17.5514 28.733 17.5783C29.1123 17.6675 29.4746 17.8177 29.8057 18.0231C29.9056 18.0849 30.0208 18.1173 30.1383 18.1166C30.2558 18.1159 30.3706 18.0821 30.4698 18.0191L30.7771 17.8237L31.1834 18.23L30.988 18.5373C30.9249 18.6365 30.8911 18.7515 30.8904 18.8691C30.8897 18.9866 30.9221 19.102 30.984 19.202C31.1894 19.5331 31.3397 19.8954 31.4289 20.2747C31.4558 20.3891 31.5145 20.4936 31.5981 20.5762C31.6817 20.6588 31.7869 20.7161 31.9016 20.7417L32.2566 20.8205V21.3953L31.9016 21.4742C31.7869 21.4998 31.6817 21.5571 31.5981 21.6397C31.5145 21.7224 31.4558 21.8269 31.4289 21.9413C31.3397 22.3206 31.1894 22.6828 30.984 23.0139C30.9221 23.1138 30.8897 23.2292 30.8904 23.3468C30.8911 23.4644 30.9249 23.5794 30.988 23.6786L31.1834 23.9858L30.7771 24.3921L30.4698 24.1967C30.3706 24.1338 30.2557 24.1 30.1383 24.0993C30.0208 24.0986 29.9055 24.131 29.8057 24.1928C29.4745 24.3982 29.1123 24.5483 28.733 24.6376C28.6186 24.6645 28.514 24.7231 28.4314 24.8067C28.3488 24.8903 28.2914 24.9955 28.2659 25.1103L28.187 25.4652H27.6123L27.5334 25.1103C27.5079 24.9955 27.4505 24.8902 27.3679 24.8066C27.2852 24.723 27.1806 24.6644 27.0662 24.6375C26.6869 24.5483 26.3247 24.3981 25.9936 24.1928C25.8937 24.1309 25.7784 24.0985 25.6609 24.0992C25.5435 24.0999 25.4286 24.1337 25.3295 24.1967L25.0222 24.3921L24.6159 23.9858L24.8112 23.6786C24.8743 23.5794 24.9082 23.4644 24.9089 23.3468C24.9096 23.2292 24.8771 23.1138 24.8152 23.0139C24.6098 22.6828 24.4595 22.3205 24.3703 21.9411C24.3434 21.8267 24.2847 21.7223 24.2011 21.6397C24.1175 21.5571 24.0123 21.4997 23.8976 21.4742L23.5427 21.3953L23.5426 20.8205ZM27.8999 23.7563C28.4238 23.7563 28.9359 23.601 29.3715 23.3099C29.807 23.0189 30.1465 22.6052 30.347 22.1212C30.5475 21.6372 30.5999 21.1047 30.4977 20.5909C30.3955 20.0771 30.1433 19.6051 29.7728 19.2347C29.4024 18.8643 28.9305 18.612 28.4167 18.5098C27.9029 18.4076 27.3703 18.4601 26.8863 18.6606C26.4023 18.861 25.9887 19.2005 25.6976 19.6361C25.4066 20.0717 25.2513 20.5838 25.2513 21.1076C25.252 21.8099 25.5313 22.4831 26.0279 22.9797C26.5244 23.4762 27.1977 23.7555 27.8999 23.7563ZM27.8999 19.7091C28.1765 19.7091 28.4469 19.7911 28.6769 19.9448C28.9069 20.0984 29.0862 20.3169 29.192 20.5724C29.2979 20.828 29.3256 21.1092 29.2716 21.3805C29.2177 21.6518 29.0845 21.901 28.8889 22.0966C28.6933 22.2922 28.4441 22.4254 28.1728 22.4793C27.9015 22.5333 27.6203 22.5056 27.3647 22.3997C27.1092 22.2939 26.8907 22.1146 26.7371 21.8846C26.5834 21.6546 26.5014 21.3842 26.5014 21.1076C26.5018 20.7368 26.6492 20.3813 26.9114 20.1191C27.1736 19.8569 27.5291 19.7094 27.8999 19.7091Z"
                                                fill="#E87556" />
                                        </svg>
                                    </div>
                                    <div class="info-area">
                                        <h6 class="title">Awesome Company Growth</h6>
                                        <p class="disc">Fusce condimentum mattis placerat odio donec lacus porta
                                            torquent, mauris gravida rutrum</p>
                                    </div>
                                </div>
        ...
        <div class="easy-steps-area rts-section-gap bg-working-steps bg_image">
            <div class="container">
                <div class="row">
                    <div class="text-center title-area-nine">
                        <p class="pre-title">
                            ...
                            <div class="icon-area">
                                <svg xmlns="http://www.w3.org/2000/svg" width="51" height="51"
                                    ...
                                    <path
                                        ...
                                        fill="#E57D61" />
                                    <path
                                        d="M45.05 40.8C45.2754 40.8 45.4916 40.7104 45.651 40.551C45.8104 40.3916 45.9 40.1754 45.9 39.95C45.9 39.7246 45.8104 39.5084 45.651 39.349C45.4916 39.1896 45.2754 39.1 45.05 39.1H34.85C34.6246 39.1 34.4084 39.1896 34.249 39.349C34.0896 39.5084 34 39.7246 34 39.95C34 40.1754 34.0896 40.3916 34.249 40.551C34.4084 40.7104 34.6246 40.8 34.85 40.8H45.05Z"
                                        fill="#E57D61" />
                                    <path
                                        d="M30.6 43.35C30.6 43.5754 30.6896 43.7916 30.849 43.951C31.0084 44.1104 31.2246 44.2 31.45 44.2H45.05C45.2754 44.2 45.4916 44.1104 45.651 43.951C45.8104 43.7916 45.9 43.5754 45.9 43.35C45.9 43.1246 45.8104 42.9084 45.651 42.749C45.4916 42.5896 45.2754 42.5 45.05 42.5H31.45C31.2246 42.5 31.0084 42.5896 30.849 42.749C30.6896 42.9084 30.6 43.1246 30.6 43.35Z"
                                        fill="#E57D61" />
                                    <path
        ...
        <div class="rts-use-case-home-9 rts-section-gap" id="projects">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="case-home-9-title-wrapper">
                            <div class="text-left title-area-nine">
                                <p class="pre-title text-start">
                                    Project Portfolio
                                </p>
        ...
        <div class="rts-testimonials-area-start bg-dream rts-section-gap">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center title-area-nine">
                    ...
                    <div class="col-lg-12">
                        <div class="testimonials-main-wrapper-nine">
                            <div class="left-image">
                                <img src="{{ asset('assets/images/testimonials/09.jpg') }}" alt="testimonials">
                            </div>
                            <div class="right-content">
                                ...
                                <p class="dsic">
                                    "Collaborating with Modern Agency felt like having an extension of our own team. Their
                                    seamless integration, prompt responses, and ability to adapt to our changing needs made
                                    them an invaluable partner in our business journey."
                                </p>
        ...
        <!-- blog area start -->
        <div class="rts-blog-area rts-section-gap style-seven" id="blog">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="text-center title-area-nine">
                        ...
                        <div class="rts-contact-fluid rts-section-gapBottom">
                            ...
                            <div class="form-wrapper">
                                <form action="#">
                                    ...
                                    <button type="submit" class="rts-btn btn-nine">Send Message</button>
                                </form>
                            </div>
                        </div>
                    </div>

...
<body class="home-blue medium-blue onepage">
                                ...
                                <div class="col-12">
                                    <div class="banner-three-inner">
                                        ...
                                        <div class="button-group">
                                            ...
                                            <a href="{{ route('aboutPage') }}" class="rts-btn btn-primary-2 transparent">About Us</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="rts-working-process-section eight rts-section-gap">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <p class="decs">We believe in the power of teamwork. We are driven by a sense of community inculcated in us through our clients, colleagues, and associates. We provide worldwide our services.</p>
                </div>
            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                        <div class="wrapper">
                            ...
                            <div class="content">
                                ...
                                <p class="disc">Customer centricity are that the is the focal point of all decisions related to products, services and experiences.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="rts-tab-style-one">
                            <div class="d-flex align-items-start contoler-company">
                                <div class="nav flex-column nav-pills me-3 button-area" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                    <button class="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">01. Information Technology</button>
                                    <button class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false">02. Hospitality</button>
                                    <button class="nav-link" id="v-pills-messages-tab" data-bs-toggle="pill" data-bs-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false">03. Logistics & Services</button>
                                    <button class="nav-link" id="v-pills-manufacture-tab" data-bs-toggle="pill" data-bs-target="#v-pills-manufacture" type="button" role="tab" aria-controls="v-pills-manufacture" aria-selected="false">04. Manufacturing</button>
                                    <button class="nav-link" id="v-pills-education-tab" data-bs-toggle="pill" data-bs-target="#v-pills-education" type="button" role="tab" aria-controls="v-pills-education" aria-selected="false">05. Education</button>
                                    <button class="nav-link" id="v-pills-customer-tab" data-bs-toggle="pill" data-bs-target="#v-pills-customer" type="button" role="tab" aria-controls="v-pills-customer" aria-selected="false">06. Customer Self-Service</button>
                                </div>
                                <div class="tab-content" id="v-pills-tabContent">
                                    ...
                                    <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                        <!-- start tab content -->
                                        <div class="rts-tab-content-one">
                                            <p><img src="{{ asset('assets/images/faq/hospitality-1.webp') }}" alt="image"></p>
                                            <p class="disc">
                                                Massa laoreet lacinia placerat eleifend cs curae imperdiet mattis
                                                taciti, scelerisque elementum velit ullamcorper praesent enim temp
                                            </p>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                                        <!-- start tab content -->
                                        <div class="rts-tab-content-one">
                                            <p><img src="{{ asset('assets/images/faq/logistics.webp') }}" alt="image"></p>
                                            <p class="disc">
                                                Massa laoreet lacinia placerat eleifend cs curae imperdiet mattis
                                                taciti, scelerisque elementum velit ullamcorper praesent enim temp
                                            </p>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-manufacture" role="tabpanel" aria-labelledby="v-pills-manufacture-tab">
                                        <!-- start tab content -->
                                        <div class="rts-tab-content-one">
                                            <p><img src="{{ asset('assets/images/faq/steel-factory.webp') }}" alt="image"></p>
                                            <p class="disc">
                                                Massa laoreet lacinia placerat eleifend cs curae imperdiet mattis
                                                taciti, scelerisque elementum velit ullamcorper praesent enim temp
                                            </p>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-education" role="tabpanel" aria-labelledby="v-pills-education-tab">
                                        <!-- start tab content -->
                                        <div class="rts-tab-content-one">
                                            <p><img src="{{ asset('assets/images/faq/education.webp') }}" alt="image"></p>
                                            <p class="disc">
                                                Massa laoreet lacinia placerat eleifend cs curae imperdiet mattis
                                                taciti, scelerisque elementum velit ullamcorper praesent enim temp
                                            </p>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-customer" role="tabpanel" aria-labelledby="v-pills-customer-tab">
                                        <!-- start tab content -->
                                        <div class="rts-tab-content-one">
                                            <p><img src="{{ asset('assets/images/faq/customer.webp') }}" alt="image"></p>
                                            <p class="disc">
                                                Massa laoreet lacinia placerat eleifend cs curae imperdiet mattis
                                                taciti, scelerisque elementum velit ullamcorper praesent enim temp
                                            </p>
    ...
    <div id="projects" class="rts-project-area eight bg-project-three margin-controlerproject mt_sm--0">
    ...
    <!-- start blog area -->
    <div id="blog" class="rts-blog-area eight rts-section-gapTop">
        <div class="container">
            <div class="row">
                        ...
                        <div class="rts-blog-h-2-wrapper">
                            ...
                            <div class="body text-start">
                                ...
                                <a href="{{ route('blogDetailsPage') }}">
                                    <h4 class="title">Profitable business makes your profit and business scale in system</h4>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="rts-blog-h-2-wrapper">
                            ...
                            <div class="body text-start">
                                <span>Business Solution / by David Dolean</span>
                                <a href="{{ route('blogDetailsPage') }}">
                                    <h4 class="title">Do a weekly roundup of relevant news and profit for your software business</h4>
                                </a>
                            </div>
                        </div>
                        <!-- single Post blog large End -->

...
@section('title')
    Home Twelve (Business Consultant)
@endsection

@section('content')

<body class="twelve-body onepage">
    ...
    <div class="swiper-banner-main-wrapper-13" id="home">
    ...
    <div class="rts-about-area-start rts-section-gap" id="about">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
    ...
    <div class="rts-callto-acation-area rts-callto-acation-area4 bg-call-to-action-two" id="cta">
        <div class="container">
            <div class="row">
                <div class="col-12">

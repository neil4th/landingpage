    ...
    <body class="index-six onepage">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <p class="top-left">Are you ready to grow up your business? <a
                                    href="{{ route('contactPage') }}">Contact Us <i class="far fa-arrow-right"></i></a></p>
                        </div>
                        ...
                        <div class=" col-xl-9 col-lg-8 col-md-8 col-sm-8 col-6">
                            <div class="main-header main-header-four main-header-five main-header-six seven">
                                ...
                                <div class="button-area">
                                    ...
                                    <a href="#"
                                        class="rts-btn btn-primary btn-primary-4 six ml--20 ml_sm--5 header-one-btn quote-btn">Book
                                        a Meeting</a>
                                    <button id="menu-btn"
                    ...
                    <nav class="nav-main mainmenu-nav">
                        <ul class="mainmenu">
                            ...
                            <li class="has-droupdown">
                                <a href="#">Pages</a>
                                <ul class="submenu">
                                    <li class="mobile-menu-link"><a href="{{ route('portfolioStyle1') }}">Project</a>
                                    </li>
                                    ...
                                    <li class="mobile-menu-link"><a href="{{ route('teamDetails') }}">Team Details</a>
                                    </li>
        ...
        <div class="rts-banner-area banner-bg-h7">
            ...
            <div class="shape-banner-6">
                <img src="{{ asset('assets/images/banner/shape/shape-h6.png') }}" alt="shape-images"
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="thumbnail">
                            ...
                            <img src="{{ asset('assets/images/about/main/about-02-sm.jpg') }}" alt="small"
                                class="small">
                ...
                <div class="row g-5 mt--20 align-items-center">
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                        ...
                        <div class="rts-working-process-1 text-center">
                            <div class="inner">
                                <div class="icon">
                                    <img src="{{ asset('assets/images/working-step/icon/09.svg') }}"
                                        alt="Working_process">
                                </div>
                            </div>
                            <div class="content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                        ...
                        <div class="rts-working-process-1 process-lg text-center">
                            <div class="inner two">
                                <div class="icon">
                                    <img src="{{ asset('assets/images/working-step/icon/10.svg') }}"
                                        alt="Working_process">
                                </div>
                            </div>
                            <div class="content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                        ...
                        <div class="rts-working-process-1 text-center">
                            <div class="inner three">
                                <div class="icon">
                                    <img src="{{ asset('assets/images/working-step/icon/11.svg') }}"
                                        alt="Working_process">
                                </div>
                            </div>
                            <div class="content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                        ...
                        <div class="rts-working-process-1 process-lg text-center">
                            <div class="inner four">
                                <div class="icon">
                                    <img src="{{ asset('assets/images/working-step/icon/12.svg') }}"
                                        alt="Working_process">
                                </div>
                            </div>
                            <div class="content">
                                    ...
                                    <div class="row g-5 w-g-100">
                                        ...
                                        <div class="col-lg-5 col-md-12 col-sm-12 col-12">
                                            <div class="bg-right-gallery">
                                                ...
                                                <a class="rts-btn btn-primary six"
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12 col-12">
                        <div class="footer-one-single-wized mid-bg">
                            ...
                            <div class="opening-time-inner">
                                ...
                                <a href="#" class="rts-btn btn-primary six contact-us">Contact Us</a>
                            </div>
                        </div>
                    </div>
                    <!-- footer mid area end -->

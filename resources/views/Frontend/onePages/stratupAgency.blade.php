...
@section('content')
    ...
    <body class="home-blue home-ten onepage">
        <!-- start header area -->
        ...
        <div class="banner-tena-area banner-bg-10 bg_image rts-section-gap" id="banner">
            <div class="container">
                <div class="row justify-content-between">
                    ...
                    <div class="col-lg-6 order-lg-2 order-md-1 order-sm-1 order-1">
                        <div class="thumbnail-img-10 pt--100">
                            <img src="{{ asset('assets/images/banner/banner-14.png') }}" alt="banner">
                            <img class="small-img" src="{{ asset('assets/images/banner/sm-1.png') }}" alt="small-image">
                            <img class="small-img-2" src="{{ asset('assets/images/banner/sm-2.png') }}"
                                alt="small-image">
                        </div>
                    </div>
                </div>
        ...
        <div class="awesome-service-ten rts-section-gap" id="services">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
        ...
        <div class="why-choose-us-section-10 rts-section-gap bg-experience-10" id="about-us">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="experience-ten-area-right">
                            ...
                            <div class="single-experience-ten-list">
                                ...
                                <div class="information">
                                    ...
                                    <p class="disc">
                                        With FINBIZ, you can expect open communication, honesty, and integrity in all our
                                        interactions. Your trust is of utmost importance to us,
                                    </p>
                                </div>
                            </div>
        ...
        <div class="rts-testimonials-area-ten rts-section-gapBottom" id="team">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="title-area-left-ten">
                ...
                <div class="row g-5 mt--30">
                        ...
                        <div class="team-style-ten bg_image">
                            <div class="thumbnail-image-team">
                                <a href="#" class="thumbnail">
                                    <img src="{{ asset('assets/images/team/tm/01.jpg') }}" alt="team">
                                </a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                        ...
                        <div class="team-style-ten bg_image">
                            <div class="thumbnail-image-team">
                                <a href="#" class="thumbnail">
                                    <img src="{{ asset('assets/images/team/tm/02.jpg') }}" alt="team">
                                </a>
                                <ul class="social-team-10">
                                    <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                        ...
                        <div class="team-style-ten bg_image">
                            <div class="thumbnail-image-team">
                                <a href="#" class="thumbnail">
                                    <img src="{{ asset('assets/images/team/tm/03.jpg') }}" alt="team">
                                </a>
                                <ul class="social-team-10">
                                    <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                        ...
                        <div class="team-style-ten bg_image">
                            <div class="thumbnail-image-team">
                                <a href="#" class="thumbnail">
                                    <img src="{{ asset('assets/images/team/tm/04.jpg') }}" alt="team">
                                </a>
                                <ul class="social-team-10">
                                    <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="#"><i class="fab fa-twitter"></i></a></li>
        ...
        <div class="blog-post-ten-area rts-section-gapTop" id="blog">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="title-area-left-ten center">
                ...
                <div class="row g-5 mt--30">
                    <div class="col-lg-6">
                        ...
                        <div class="single-blog-style-ten">
                            <a href="{{ route('blogDetailsPage') }}" class="thumbnail">
                                <img src="{{ asset('assets/images/blog/17.png') }}" alt="blog">
                            </a>
                            <div class="information">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="single-blog-style-ten">
                            <a href="{{ route('blogDetailsPage') }}" class="thumbnail">
                                <img src="{{ asset('assets/images/blog/18.png') }}" alt="blog">
                            </a>
                            <div class="information">
                                <div class="blog-top-area">
                                    <div class="single-area">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="single-blog-style-ten">
                            <a href="{{ route('blogDetailsPage') }}" class="thumbnail">
                                <img src="{{ asset('assets/images/blog/19.png') }}" alt="blog">
                            </a>
                            <div class="information">
                                <div class="blog-top-area">
                                    <div class="single-area">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="single-blog-style-ten">
                            <a href="{{ route('blogDetailsPage') }}" class="thumbnail">
                                <img src="{{ asset('assets/images/blog/20.png') }}" alt="blog">
                            </a>
                            <div class="information">
                                <div class="blog-top-area">
                                    <div class="single-area">
        ...
        <div class="rts-contact-form-area rts-section-gapTop" id="contacts-down">
            <div class="container">
                <div class="row">
                    <div class="col-12">

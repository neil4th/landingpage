...
@section('title')
    Our Services (Business Consultant)
@endsection
@section('content')
            ...
            <div class="row g-5 service padding-controler">
                ...
                <div class="col-xl-4 col-md-6 col-sm-12 col-12 pb--140 pb_md--100">
                    <div class="service-two-inner">
                        <a href="{{ route('serviceDetailsPage') }}" class="thumbnail"><img
                                src="{{ asset('assets/images/service/02.jpg') }}" alt="Business_image"></a>
                        <div class="body-content">
                            <div class="hidden-area">
                                ...
                                <a class="rts-read-more-two color-primary" href="{{ route('serviceDetailsPage') }}">Read
                ...
                <div class="col-xl-4 col-md-6 col-sm-12 col-12 pb--140 pb_md--100">
                    <div class="service-two-inner">
                        <a href="{{ route('serviceDetailsPage') }}" class="thumbnail two"><img
                                src="{{ asset('assets/images/service/03.jpg') }}" alt="Business_image"></a>
                        <div class="body-content">
                            <div class="hidden-area">
                ...
                <div class="col-xl-4 col-md-6 col-sm-12 col-12 pb--140 pb_md--100">
                    <div class="service-two-inner">
                        <a href="{{ route('serviceDetailsPage') }}" class="thumbnail three"><img
                                src="{{ asset('assets/images/service/04.jpg') }}" alt="Business_image"></a>
                        <div class="body-content">
                            <div class="hidden-area">
